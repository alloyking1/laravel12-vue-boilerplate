                                ...
                                <div class="">
                                    <form @submit.prevent="createBusiness()" class="grid items-start gap-2">
                                        <div class="grid grid-cols-2 gap-2">
                                            <div>
                                                <Input id="name" v-model="newBusiness.name" type="text" placeholder="Business name" />
                                            </div>
                                            <div class="">
                                                <Input v-model="newBusiness.email" id="phone" type="email" placeholder="Business email" />
                                                
                                            </div>
                                        </div>
                                        <div class="grid gap-2">
                                            <select id="company_size" v-model="newBusiness.company_size"
                                                    ...
                                                    >
                                                    <option value="" class="tex-xs text-muted-foreground" selected disabled>Team Size</option>
